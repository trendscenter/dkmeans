...
from dkmeans.remote_computations import dkm_remote_closest_centroids
...
def test_dkm_remote_aggregate_clusters():
...
def test_dkm_remote_aggregate_sum():
...
def test_dkm_remote_closest_centroids():
    m, n, k, s, _ = DEFAULT_PARAMS
...
"""
def test_dkm_local_compute_mean():
...
def test_dkm_local_compute_clustering():
    m, n, k, s, N = DEFAULT_PARAMS
    C = _k_cluster_labels(N, k)
